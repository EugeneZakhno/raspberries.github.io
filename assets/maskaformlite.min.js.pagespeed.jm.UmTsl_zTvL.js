!function (a) {
    ...
    function h(e, f, g) {
        ...
        function w(b, c, d) {
                ...
                function j(f, h, l) {
                    function q(b, c) {
                        ...
                        return d || a.each(c.matches, function (a, e) {
                            return e.isQuantifier === !0 && (d = q(b, c.matches[a - 1])) ? !1 : void 0
                        }), d
                    }
                    ...
                    function s(a, c) {
                        return null === a.match.fn && null !== c.match.fn ? c.match.fn.test(a.match.def, m(), b, !1, g, !1) : !1
                    }
                            ...
                            if (-1 === A || "string" == typeof A) {
                                ...
                                for (var F = 0; F < E.length; F++) {
                                    ...
                                    for (var H = 0; H < u.length; H++) {
                                        ...
                                        for (var K = 0; K < x.length; K++) {
                                            var L = x[K];
                                            if (("string" != typeof A || -1 !== a.inArray(I.locator[I.alternation].toString(), E)) && (I.match.def === L.match.def || s(I, L))) {
                                                J = I.match.mask === L.match.mask, -1 === L.locator[I.alternation].toString().indexOf(I.locator[I.alternation]) && (L.locator[I.alternation] = L.locator[I.alternation] + "," + I.locator[I.alternation], L.alternation = I.alternation);
                                                break
                                            }
                                        }
                                        J || x.push(I)
                                ...
                                "string" == typeof A && (x = a.map(x, function (b, c) {
                                    if (isFinite(c)) {
                                        ...
                                        for (var g = 0; g < f.length; g++) d = -1 !== a.inArray(f[g], E), d && (void 0 !== b.locator[e] ? (b.locator[e] += ",", b.locator[e] += f[g]) : b.locator[e] = parseInt(f[g]), b.alternation = e);
                                        if (void 0 !== b.locator[e]) return b
                                    }
                                })), n = y.concat(x), k = b, o = n.length > 0, d = D.slice()
                            } else f = j(w.matches[A] || c.matches[A], [A].concat(h), l);
                            if (f) return !0
                        } else if (f.isQuantifier && l !== c.matches[a.inArray(f, c.matches) - 1]) for (var M = f, N = d.length > 0 ? d.shift() : 0; N < (isNaN(M.quantifier.max) ? N + 1 : M.quantifier.max) && b >= k; N++) {
            ...
            }), void 0 !== c && m().tests[b] ? a.extend(!0, [], n) : (m().tests[b] = a.extend(!0, [], n), m().tests[b])
        }
        ...
        function z(a, b, c) {
            var d;
            if (a === !0) n(), a = 0, b = c.length; else for (d = a; b > d; d++) delete m().validPositions[d];
        ...
        function C(c, d, e, f) {
            ...
            function i(b, d, e, f) {
                ...
                return a.each(w(b), function (j, k) {
                    ...
                    if (d && (s += d), y(!0), i = null != l.fn ? l.fn.test(s, m(), b, e, g, h(c)) : d !== l.def && d !== g.skipOptionalPartCharacter || "" === l.def ? !1 : {
                        ...
                        return i !== !0 && void 0 === i.pos && void 0 === i.c ? !1 : (j > 0 && n(!0), p(v, a.extend({}, k, {input: A(u, l, v)}), f, h(c)) || (i = !1), !1)
                    }
                }), i
            }

            function j(b, c, d, e) {
                for (var f, h, i, j, k, l, p = a.extend(!0, {}, m().validPositions), q = o(); q >= 0 && (j = m().validPositions[q], !j || void 0 === j.alternation || (f = q, h = m().validPositions[f].alternation, s(f).locator[j.alternation] === j.locator[j.alternation])); q--) ;
                if (void 0 !== h) {
                    f = parseInt(f);
                    for (var r in m().validPositions) if (r = parseInt(r), j = m().validPositions[r], r >= f && void 0 !== j.alternation) {
                        var t;
                        ...
                        var u = void 0 !== j.locator[h] ? j.locator[h] : t[0];
                        u.length > 0 && (u = u.split(",")[0]);
                        for (var w = 0; w < t.length; w++) {
                            var x = [], y = 0, z = 0;
                            if (u < t[w]) {
                                for (var A, B, D = r; D >= 0; D--) if (A = m().validPositions[D], void 0 !== A) {
                                    var E = v(D, t[w]);
                                    m().validPositions[D].match.def !== E.match.def && (m().validPositions[D].generatedInput !== !0 && x.push(m().validPositions[D].input), m().validPositions[D] = E, m().validPositions[D].input = I(D), null === m().validPositions[D].match.fn && z++, A = E), B = A.locator[h], A.locator[h] = parseInt(t[w]);
                                    break
                                }
                                if (u !== A.locator[h]) {
                                    for (k = r + 1; k < o(void 0, !0) + 1; k++) l = m().validPositions[k], l && null != l.match.fn ? x.push(l.input) : b > k && y++, delete m().validPositions[k];
                                    for (n(!0), g.keepStatic = !g.keepStatic, i = !0; x.length > 0;) {
                                        var F = x.shift();
                                        if (F !== g.skipOptionalPartCharacter && !(i = C(o(void 0, !0) + 1, F, !1, e))) break
                                    }
                                    if (A.alternation = h, A.locator[h] = B, i) {
                                        var G = o(b) + 1;
                                        for (k = r + 1; k < o() + 1; k++) l = m().validPositions[k], (void 0 === l || null == l.match.fn) && b > k && z++;
                                        b += z - y, i = C(b > G ? G : b, c, d, e)
                                    }
                                    if (g.keepStatic = !g.keepStatic, i) return i;
                                    n(), m().validPositions = a.extend(!0, {}, p)
                                }
                            }
                        }
                        break
            ...
            return t === !1 && g.keepStatic && (t = j(l, d, e, f)), t === !0 && (t = {pos: l}), a.isFunction(g.postValidation) && t !== !1 && !e && f !== !0 && (t = g.postValidation(y(!0), t, g) ? t : !1), void 0 === t.pos && (t.pos = l), t === !1 && (n(!0), m().validPositions = a.extend(!0, {}, u)), t
        }
        ...
        function I(a, b) {
            ...
            if (null === b.fn) {
                if (a > -1 && !g.keepStatic && void 0 === m().validPositions[a]) {
                    var c, d = w(a), e = [];
                    if (d.length > 2) for (var f = 0; f < d.length; f++) if (d[f].match.optionality !== !0 && d[f].match.optionalQuantifier !== !0 && (null === d[f].match.fn || void 0 === c || d[f].match.fn.test(c.match.def, m(), a, !0, g) !== !1) && (e.push(d[f]), null === d[f].match.fn && (c = d[f]), e.length > 1 && new RegExp("[0-9a-bA-Z]").test(e[0].match.def))) return g.placeholder.charAt(a % g.placeholder.length)
                }
                return b.def
            }
        ...
        function J(c, d, e, f) {
            ...
            if (n(), m().p = E(-1), !e) if (g.autoUnmask !== !0) {
                var p = x().slice(0, E(-1)).join(""), q = j.join("").match(new RegExp("^" + b.escapeRegex(p), "g"));
            ...
            a.each(j, function (b, d) {
                if (void 0 !== d) {
                    ...
                    var j = o(void 0, !0), p = m().validPositions[j], q = s(j + 1, p ? p.locator.slice() : void 0, j);
                    if (!h() || e || g.autoUnmask) {
        ...
        function M(b) {
            var c, d, e = y(), f = e.length, g = o(), h = {}, i = m().validPositions[g],
    ...
    return b.extendAliases({
        numeric: {
            ...
            postFormat: function (c, d, e) {
                ...
                var j = i.join(""), k = j;
                if (j = j.replace(new RegExp(b.escapeRegex(e.suffix) + "$"), ""), j = j.replace(new RegExp("^" + b.escapeRegex(e.prefix)), ""), j.length > 0 && e.autoGroup || -1 !== j.indexOf(e.groupSeparator)) {
                ...
                var o = k !== j;
                if (o) for (c.length = j.length, f = 0, g = j.length; g > f; f++) c[f] = j.charAt(f);
                var p = a.inArray("!", j);
                ...
                if (!e) {
                    ...
                    if (h.splice(0, f.prefix.length), h.splice(h.length - f.suffix.length, f.suffix.length), f.numericInput === !0) {
                        ...
                        var j = a.inArray(f.radixPoint, h),
                            k = h.slice(0, -1 !== j ? j : void 0).join("").match(f.regex.integerNPart(f));
                        if (k && (-1 === j || j >= d)) {
                            var l = -1 === j ? 0 : parseInt(h.slice(j + 1).join(""));
    ...
    return b.extendAliases({
        abstractphone: {
            countrycode: "", phoneCodes: [], mask: function (a) {
                return a.definitions = {"#": a.definitions[9]}, a.phoneCodes.sort(function (a, b) {
                    return (a.mask || a) < (b.mask || b) ? -1 : 1
                })
            }, keepStatic: !1, onBeforeMask: function (a, b) {
